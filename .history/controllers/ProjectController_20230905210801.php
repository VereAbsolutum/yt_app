...
class ProjectController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($project->load(Yii::$app->request->post()) && $project->save()) {
            // Dividir o text em partes iguais de 100 caracteres
            $partes = str_split($project->text, 100);
    ...
    public function actionUpdate($id)
    {
        ...
        if ($project->load(Yii::$app->request->post()) && $project->save()) {
            // Atualizar as partes do text
            foreach ($project->processedText as $processedText) {
                if ($processedText->load(Yii::$app->request->post()) && $processedText->save()) {
                    // A parte do text foi atualizada com sucesso
                } else {
                    // Ocorreu um erro ao atualizar a parte do text
                }
            }
