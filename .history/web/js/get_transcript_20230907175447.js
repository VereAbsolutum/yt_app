...
// Exemplo de chamada da função para obter a transcrição de um vídeo específico
obterTranscricaoDoVideo('VIDEO_ID'); // Substitua 'VIDEO_ID' pelo ID do vídeo do YouTube desejado
