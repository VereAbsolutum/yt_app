                ...
                <div class="your-model-form">
                    ...
                    <div class="form-group">
                        <?= $form->field($video, 'link', [
                            'template' => "{label}\n<div class='input-group'>{input}<span class='input-group-btn'><button type='button' class='btn btn-success ms-2' id='transcript-button'> Play <strong>></strong> </button></span></div>\n{hint}\n{error}",
                        ])->textInput([
