...
// Registre o AssetBundle que contém o JavaScript
        ...
        <div class="col">
            <div class="card px-3 py-5">
                <div class="your-model-form">
                    <?php
                    $action = isset($dataProvider) ? ['create'] : ['update', 'id' => $project->id];
                    ...
                    <div class="form-group">
                        <?= $form->field($video, 'link', [
                            'template' => "{label}\n<div class='input-group'>{input}<span class='input-group-btn'><button type='button' class='btn btn-success ms-2' id='transcript-button'> Play <i class='fas fa-play'></i> </button></span></div>\n{hint}\n{error}",
                        ])->textInput([
