            ...
            <div class="card px-3 py-5">
                <?= GridView::widget([
                    ...
                    'pager' => [
                        ...
                        'options' => ['class' => 'pagination justify-content-center'], // Estilize a paginação como desejado
                        'prevPageCssClass' => 'page-item',
                        'nextPageCssClass' => 'page-item',
                        'pageCssClass' => 'page-item',
                        'activePageCssClass' => 'active',
                        'prevPageLabel' => '<span class="page-link">Anterior</span>',
                        'nextPageLabel' => '<span class="page-link">Próximo</span>',
                        'firstPageLabel' => '<span class="page-link">Primeira</span>',
                        'lastPageLabel' => '<span class="page-link">Última</span>',
                        'maxButtonCount' => 5, // Defina o número de botões de página exibidos
                    ],
                ]); ?>
